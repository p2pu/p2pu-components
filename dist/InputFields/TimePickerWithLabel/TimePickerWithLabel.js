...
var _excluded = ["name", "id", "label", "required", "disabled", "value", "helpText", "classes", "selectClasses", "handleChange", "noResultsText", "placeholder", "isMulti", "isClearable"];
...
var TimePickerWithLabel = function TimePickerWithLabel(props) {
  ...
  var _useState = useState(props.errorMessage),
